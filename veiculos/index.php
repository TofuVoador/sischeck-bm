...
$sql = "SELECT v.*, s.nome as setor_nome, c.nome as compartimento_nome, mnv.id as id_mnv, MAX(ch.data_check) as 'verificado', u.nome as 'verificador' FROM veiculo as v
